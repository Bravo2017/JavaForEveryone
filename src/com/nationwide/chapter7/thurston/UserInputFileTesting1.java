...
public class UserInputFileTesting1 {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		File userOpened = new File("C:\\HomeWork\\countable.txt");
		...
		// int wordCounter = 0;
		/*
		 * Scanner sc = new Scanner(new FileInputStream(userOpened)); { int
		 * count = 0; while (sc.hasNext()) { sc.next(); count++; }
