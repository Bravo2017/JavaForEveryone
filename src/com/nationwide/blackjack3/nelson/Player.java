...
public class Player {
	...
	private Card[] hand = new Card[10];		// maximum number of cards a player can have in one hand
											//	   hard-coding to 10 - if change, make change below
	 ...
	 * @return 	true/false	whether the sum of the new hand if below or equal to 21
	 */
	...
	public int getHandSum()
	{
		...
		for (int c = 0; c < this.numCards; c++)		// loop to add card's points to hand sum
		{
			cardNum = this.hand[c].getNumber();		// get current card number (see Card class)
		...
		// if handSum is over 21 and we have aces, set some/all of them to value 1
	 ...
	 * @param showFirstCard whether the first card is shown or not
	 */
