...
public class AppointmentBook {
	...
	/**
	 * extracts, from an appointment book, a list of the appointments that occur
	 * on a particular day
	 * 
	 * @param date
	 *            the day of the appointments to list
	 * @return returns an Arraylist of appointments on a particular day
	 */
	public ArrayList<Appointment> getDayList(String date) {
